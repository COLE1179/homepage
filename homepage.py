...
st.sidebar.markdown("[Project designed: House prices prediction Application](https://hearcheck.streamlit.app/)")
st.sidebar.markdown("[Project Designed: Heart disease prediction Application](https://predicthouse.streamlit.app/)")
